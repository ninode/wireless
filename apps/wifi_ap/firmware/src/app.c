...
void APP_APShowConnectedDevices()
{
    ...
    if (numDhcpsPoolEntries > 0)
    {
        ...
        SYS_MESSAGE("--------------------------------------------\r\n");
        SYS_MESSAGE("           Connected devices summary\r\n");
        SYS_MESSAGE("--------------------------------------------\r\n\r\n");
        SYS_MESSAGE("MAC Address              IP Address\r\n");
    ...
    {
        SYS_MESSAGE("No device is connected\r\n");
    }
}
...
{    
    ...
    {
        SYS_MESSAGE("Set visibility fail \r\n");
        return false;
    }
    ...
    switch (authMode) 
    {
        ...
        default:
        {
            SYS_PRINT("APP: Unknown Authentication type\r\n");
            return false;
        }
    }
