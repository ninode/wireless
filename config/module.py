...
def loadModule():
    ...
    ## WIFI Driver
    drvWifiWincComponent = Module.CreateComponent("drvWifiWinc", "WINC Driver", "/Harmony/Drivers/Wi-Fi/", "driver/winc/config/drv_winc.py")
    drvWifiWincComponent.addCapability("wdrv_winc", "WDRV_WINC")
    
    drvWifiPic32mzw1Component = Module.CreateComponent("drvWifiPic32mzw1", "PIC32MZW1 Driver", "/Harmony/Drivers/Wi-Fi/", "driver/pic32mzw1/config/drv_pic32mzw1.py")
