...
def loadModule():
    ...
    appSerBridge = Module.CreateComponent('appWincSerialBridge', 'Serial Bridge Application', '/Applications/WINC/', 'apps/serial_bridge/config/app_winc_serial_bridge.py')
