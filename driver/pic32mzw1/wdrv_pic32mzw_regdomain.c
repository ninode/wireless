...
)
{
    WDRV_PIC32MZW_DCPT *const pDcpt = (WDRV_PIC32MZW_DCPT *const)handle;
    DRV_PIC32MZW_WIDCTX wids;
    char widRegName[WDRV_PIC32MZW_REGDOMAIN_MAX_NAME_LEN];
    ...
    memset(widRegName, 0, WDRV_PIC32MZW_REGDOMAIN_MAX_NAME_LEN);
    strncpy(widRegName, pRegDomain, WDRV_PIC32MZW_REGDOMAIN_MAX_NAME_LEN);
